@php
    ...
    $menuLaporan = Request::is('report-student-tuition') || Request::is('report-student-tuition/*') || Request::is('expense-report') || Request::is('expense-report/*') || Request::is('reports/students') || Request::is('reports/students/*') || Request::is('reports/invoices') || Request::is('reports/invoices/*') || Request::is('report-school-finances') ? 'show' : '';
@endphp
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @can('report-school-finances.index')
                    <a href="{{ route('report-school-finances.index') }}"
                        class="collapse-item {{ Request::is('report-school-finances') || Request::is('report-school-finances/*') ? 'active' : '' }}">
                        Keuangan Sekolah
                    </a>
                @endcan
                @can('students.report')
