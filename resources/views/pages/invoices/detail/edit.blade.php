    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('invoice-details.index', $invoice->getKey()) }}"
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoice-details.update', [$invoice->getKey(), $detail->getKey()]) }}"
                        method="post">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('item_name') is-invalid @enderror"
                                        ...
                                        value="{{ old('item_name', $detail->item_name) }}" autocomplete="off" tabindex="1"
                                        autofocus>
                                    @error('item_name')
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('price') is-invalid @enderror"
                                        ...
                                        value="{{ old('price', $detail->price) }}" autocomplete="off" tabindex="2">
                                    @error('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
