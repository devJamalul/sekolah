              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('note') is-invalid @enderror" name="note"
                    id="note" aria-describedby="note" value="{{ old('note') }}" autocomplete="off" tabindex="1" autofocus>
                  @error('note')
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control @error('due_date') is-invalid @enderror" name="due_date"
                    id="due_date" aria-describedby="due_date" value="{{ old('due_date') }}" autocomplete="off" tabindex="4">
                  @error('due_date')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
