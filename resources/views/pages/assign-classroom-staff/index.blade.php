...
@push('css')
    <style>
        #staffs tbody tr.selected {
            background-color: #4e72dfbd;
            color: white;
        }

        #staffs-classroom tbody tr.selected {
                    ...
                    <div class="w-75 ml-5  d-flex flex-column">
                        <div class="row d-flex  mt-4 justify-content-between">
                            <div class="col-8">
                                ...
                                <form action="{{ route('assign-classroom-staff.store') }}" class="row" method="post">
                                    <div class="col-6">
                                        @csrf
                    ...
                    <div class="card-body ">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="w-75 d-flex flex-column">
                                @php
                                    $tableColumns = [['data' => 'id'], ['data' => 'id'], ['data' => 'name'], ['data' => 'dob']];
                                @endphp
