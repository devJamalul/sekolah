                    ...
                    <form action="{{ route('edit-profile.update') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                {{-- Phone --}}
                                <div class="form-group">
                                    <label for="phone_number">Nomor Telepon<span class="text-small text-danger">*</span></label>
                                ...
                                {{-- NIK --}}
                                <div class="form-group">
                                    <label for="nik">Nomor Induk Kependudukan (KTP)<span class="text-small text-danger">*</span></label>
