                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="father_email" value="{{ old('father_email') }}" id="father_email" class="form-control @error('father_email') is-invalid @enderror">
                        @error('father_email')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <textarea name="father_address" id="father_address" rows="4" class="form-control @error('father_address') is-invalid @enderror">{{ old('father_address') }}</textarea>
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="mother_name" id="mother_name" value="{{ old('mother_name') }}" class="form-control @error('mother_name') is-invalid @enderror">
                        @error('mother_name')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="mother_email" value="{{ old('mother_email') }}" id="mother_email" class="form-control @error('mother_email') is-invalid @enderror">
                        @error('mother_email')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <textarea name="mother_address" id="mother_address" rows="4" class="form-control @error('mother_address') is-invalid @enderror">{{ old('mother_address') }}</textarea>
                        <div class="form-check">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="guardian_email" value="{{ old('guardian_email') }}" id="guardian_email" class="form-control @error('guardian_email') is-invalid @enderror">
