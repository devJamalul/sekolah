...
@section('content')
    ...
    <div class="col-lg-6">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <div>
                <a href="{{ route('tuition-master.index', ['id' => $student_id]) }}"
        ...
        <div class="card">
            <div class="card-body">
                <form
                    action="{{ route('tuition-master.update', ['id' => $student_id, 'tuition_master' => $current_tuition->id]) }}"
                    method="post">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="price" name="price"
                            value="{{ old('price', $current_tuition->price) }}" id="price"
