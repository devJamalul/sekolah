        ...
        try {
            ...
            foreach ($collection as $key => $item) {
                // Save Student
                    ...
                    $student->dob                       = Carbon::instance(\PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($item['tanggal_lahir']));
                ...
                $class = Classroom::where('name', $item['kelas'])->first();
                ...
                $tuition = Tuition::query()->where('tuition_type', function ($q) use ($item) {
                    $q->where('name', $item['tipe_uang_sekolah']);
                })->where([
