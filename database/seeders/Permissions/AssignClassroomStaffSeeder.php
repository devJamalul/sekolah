...
class AssignClassroomStaffSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $roles = [
            'index'   => 'assign-classroom-staff.index',
            'store'  => 'assign-classroom-staff.store',
            'destroy' => 'assign-classroom-staff.destroy'
        ];
