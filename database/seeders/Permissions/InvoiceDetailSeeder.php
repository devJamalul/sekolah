...
class InvoiceDetailSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $roles = [
            'index' => 'invoice-details.index',
            'create' => 'invoice-details.create',
            'store' => 'invoice-details.store',
            'edit' => 'invoice-details.edit',
            'update' => 'invoice-details.update',
            'destroy' => 'invoice-details.destroy'
        ];
        ...
        $permission->syncRoles([$super_admin, $ops_admin, $admin_sekolah, $tata_usaha, $bendahara]);
